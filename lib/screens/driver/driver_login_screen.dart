            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    context.read<AuthProvider>().loginAsDriver(
                      _emailController.text,
                      _passwordController.text,
                    );
                    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const DriverHomeScreen()));
                  },
                  ...
                  child: const Text('Login as Driver', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                ),
              ),
              const SizedBox(height: 32),
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => const DriverRegistrationScreen()));
                    },
